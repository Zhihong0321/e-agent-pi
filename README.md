...
| `agent/model-catalog.json` | Luna + Kimi + GLM 5.3 + OpenCode GO (GLM 5.3 Flash, Qwen 3.8 Flash, DeepSeek V4 Flash Vision) + YerPlan (GLM 5.3 Flash) + Hive AI (GLM 5.3 Flash) catalog |
