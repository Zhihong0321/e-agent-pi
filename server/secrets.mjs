...
export function publicSettings() {
  return {
    ...
    opencodeGoApiKeySet: Boolean(secret("opencode_go_api_key")),
    opencodeGoBaseUrl: secret("opencode_go_base_url") || "https://opencode.ai/zen/go/v1",
    hiveAiApiKeySet: Boolean(secret("hive_ai_api_key")),
    hiveAiBaseUrl: secret("hive_ai_base_url") || "https://api.thehive.ai/api/v3",
    yerplanApiKeySet: Boolean(secret("yerplan_api_key")),
    yerplanBaseUrl: secret("yerplan_base_url") || "https://api.qiyue999.com/v1",
...
export function secretFlags() {
  return {
    ...
    opencodeGoApiKey: Boolean(secret("opencode_go_api_key")),
    hiveAiApiKey: Boolean(secret("hive_ai_api_key")),
    yerplanApiKey: Boolean(secret("yerplan_api_key")),
