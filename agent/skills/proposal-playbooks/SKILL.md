---
name: proposal-playbooks
description: Step-by-step recipes for editing ee-proposal (warranty lines, certifications, invoice/demo data, panel/inverter defaults, Why-Eternalgy/Why-Jinko/Marcap copy, images, push, and the render-verify command). Load this before making any edit — the context pack only lists the playbook names.
---
