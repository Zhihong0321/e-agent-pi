---
name: website-playbooks
description: Step-by-step recipes for editing the Website Dev Agent's static site (text/value changes, certification rows, verified metrics, images, fonts, adding a section, redesigns, workspace cleanup). Load this before making any edit — the context pack only lists the playbook names.
---
